...
#define STRING_CONFIG_H_AUTHOR "(SK-Go² Sleg Edition)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SK-Go² v.Sleg"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki   .70
    #define DEFAULT_Kd  37.86
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 696.43 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, 55, -1.55 }
